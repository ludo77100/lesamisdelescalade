...
public class LongueurController {
	...
	public String formLongueur(Model model, @PathVariable("spotId")Long spotId, @PathVariable("secteurId")Long secteurId,@PathVariable("voieId")Long voieId) {
	...
	/*
	 * @PostMapping("/spot/{spotId}/secteur/{secteurId}/ajouterVoie/save") public
	 * String saveVoie(Model model, @ModelAttribute("voieForm")VoieForm
	 * voieForm, @PathVariable("spotId")Long spotId, @PathVariable("secteurId")Long
	 * secteurId, BindingResult result, RedirectAttributes redirectAttributes) {
	 * 
